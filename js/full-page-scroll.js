...
(function () {
    ...
    fullScroll.prototype.addEvents = function () {
        ...
        if (document.addEventListener) {
            ...
            window.addEventListener("resize", this.hashChange, false)
    ...
    fullScroll.prototype.buildPublicFunctions = function () {
        ...
        this.animateScroll = function () {
            ...
            var heights = Array.from(document.getElementsByTagName("section"))
                .map(sec => sec.clientHeight);
            ...
            this.defaults.container.style.msTransform = 'translateY(-' + position + 'px)';
            this.defaults.container.style.transform = 'translateY(-' + position + 'px)';
